...
const stack = {
  Engine: ["WebGL2 shaders", "Canvas 2D fallback", "TypedArray pixel ops"],
  Frontend: ["React 19", "TanStack Start", "Tailwind v4"],
  Runtime: ["Client-side only", "Zero install", "Works offline once loaded"],
};
    ...
    <div className="min-h-screen bg-background text-foreground font-sans overflow-x-hidden">
      ...
      <section id="top" className="relative pt-16 min-h-screen">
        ...
        <div className="relative z-10 max-w-[1400px] mx-auto px-6 lg:px-10 pt-20 pb-24 lg:pt-32 lg:pb-40 grid lg:grid-cols-12 gap-8 items-end min-h-[calc(100vh-4rem)]">
          ...
          <div className="lg:col-span-4 lg:pl-6 space-y-4 font-mono text-xs">
            <TerminalRow label="runtime" value="browser" accent />
            <TerminalRow label="attack" value="FGSM-style" />
            <TerminalRow label="epsilon" value="0.005 – 0.050" />
            <TerminalRow label="uploads" value="none" />
            <TerminalRow label="exif" value="stripped" />
          ...
          <div className="grid lg:grid-cols-12 gap-10">
            <div className="lg:col-span-7 space-y-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                <MethodCard
                  tag="Fast · single-step"
                  name="FGSM"
                  desc="Fast Gradient Sign Method. A single high-frequency perturbation pass — cheap enough to run on any laptop, right in the tab."
                  accent
                />
                <MethodCard
                  tag="In-browser · zero upload"
                  name="Canvas"
                  desc="Everything happens on a canvas element. Your file never touches a server unless you explicitly send it to the AI scanner."
                />
              </div>
          ...
          <div className="mt-24 grid lg:grid-cols-12 gap-10 items-end">
            <div className="lg:col-span-5">
              ...
              <h3 className="font-display text-3xl lg:text-5xl leading-tight">
                <span className="italic">Zero</span> install,
                <br />zero uploads.
              </h3>
            </div>
            <div className="lg:col-span-7 space-y-4 text-muted-foreground text-lg leading-relaxed">
              <p>
                Everything runs on your machine, right in the tab. Pixels are
                touched by JavaScript alone:
              </p>
              <ul className="space-y-2 font-mono text-sm">
                <li className="flex gap-3"><span className="text-lime">→</span> image decoded and resized on an offscreen canvas</li>
                <li className="flex gap-3"><span className="text-lime">→</span> per-pixel sign perturbation blended into the original</li>
                <li className="flex gap-3"><span className="text-lime">→</span> nothing leaves your browser unless you scan it</li>
              </ul>
            </div>
      ...
      <section id="stack" className="max-w-[1400px] mx-auto px-6 lg:px-10 py-24 lg:py-32">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4 font-mono text-sm">
          {[
            "Client-side adversarial perturbation",
            "Adjustable epsilon slider",
            "Real-time canvas preview",
            "AI vision scanner (before / after)",
      ...
      <section id="get" className="border-t border-border relative overflow-hidden">
        ...
        <div className="relative max-w-[1400px] mx-auto px-6 lg:px-10 py-32 lg:py-48 text-center">
          ...
          <p className="mt-8 max-w-xl mx-auto text-lg text-muted-foreground">
            Inkshield runs entirely in your browser — no install, no account,
            no upload. Load your art, dial in a shield, download the protected
            file. That's it.
          </p>
